...
// var obj = JSON.parse(staffJSON);

// // console.log(obj[0].fName);

// for (var i = 0; i < obj.length; i++) {
//   dispStr += `${obj[i].fName} ${obj[i].age}<br/>`;
// }


//2. Joke
// var obj = JSON.parse(jokeStr);
// dispStr = obj.value;


//3. Wx
var obj = JSON.parse(wxStr);
// var currentDate = obj.current.dt;
// var d = new Date(currentDate * 1000);
// console.log(d.toLocaleDateString());

// var tempK = obj.current.temp;
